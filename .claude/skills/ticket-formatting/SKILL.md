...
- OS + version
- Thumbscope version
- File variant: A / B / C / ehthumbs / ivThumbs flat / ivThumbs nested / recovered
...
Bug form adds a required `File variant` dropdown (A / B / C / ehthumbs / ivThumbs flat / ivThumbs nested / recovered) and OS + version inputs.
